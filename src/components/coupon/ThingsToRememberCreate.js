...
export const ThingsToRememberCreate = () => {
  ...
  const create = async (e) => {
    ...
    const res = await axios.post("http://localhost:3124/api/thingstoremember/new", {
      title,
      info,
      isdefault,
      status
  ...
  return (
    <div className='item-create'>
      <h2 className='item-heading-create'>ThingsToRemember | Create</h2>
      <form>
