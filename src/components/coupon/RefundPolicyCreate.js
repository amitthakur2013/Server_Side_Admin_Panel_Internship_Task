...
export const RefundPolicyCreate = () => {
  ...
  const create = async (e) => {
    ...
    const res = await axios.post("http://localhost:3124/api/refundpolicy/new", {
      title,
      info,
      isdefault,
      status
  ...
  return (
    <div className='item-create'>
      <h2 className='item-heading-create'>Refund Policy| Create</h2>
      <form>
