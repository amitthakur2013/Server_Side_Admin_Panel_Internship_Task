...
module.exports = ({ pId,merchant,address_line1,state,zip_code,vchr_code,vchr_amt,adult,child,status,valid_from,valid_to,from_date,to_date,image }) => {
...
section of the app
        ...
        <div class="col-xs-4" style="margin-left:10px ">
          <div style="padding: 3px" class="row">
            <img style="width: 150px;height: 120px" src="${image}">
          </div>
